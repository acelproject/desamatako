  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-60 text-white flex items-center justify-between z-[99999]">
        <button className="bg-primary text-2xl h-10 w-10 left-16 rounded-full flex justify-center items-center prev-btn">
          <IoIosArrowBack />
        </button>
        <button className="bg-primary text-2xl h-10 w-10 rounded-full flex justify-center items-center  next-btn">
          <IoIosArrowForward />
        </button>
      </div>
    </div>
