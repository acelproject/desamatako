  ...
  return (
    <div>
      {/* <div className="w-full flex px-20 gap-10 mt-4">
        <div className="w-[70%] ">
          ...
          <p className="text-gray-600 text-md text-justify">
            ...
            <span className="font-semibold">MATAKO</span>, dan sebutan tersebut
            melekat hingga sekarang.
          </p>
          <br />
          <p className="text-gray-600 text-md w-full text-justify">
            Dr. Albert Cruit menghimbau dan memohon agar semua warga masyarakat
            yang hidup terpencar dan berkelompok di daerah perbukitan untuk
            turun ke daerah dataran rendah wilayah pantai untuk membuat
            pemukiman yang disebut kampoeng (Kampung), dengan Kepala Kampung
            pertama “PEDENGKA”. Seorang kepala suku yang diangkat oleh
            masyarakat sebagai “KABOSENYA” (Kabosenya Katundana), dengan luas
            wilayah kerja dari GALUGA sampai TONGKO.
          </p>
          <br />
          <p className="text-gray-600 text-md w-full text-justify">
            ...
            Desa Malei Tojo) dan Matako B (yakni Desa Matako yang sekarang ini).
          </p>
          <br />
          <p className="text-gray-600 text-md w-full text-justify">
      ...
      <div className="w-full px-20 gap-10 mt-5 ">
        ...
        <br />
        <p className="text-gray-600 text-md w-full text-justify">
          Luas wilayah Desa Matako adalah + 9000 ha. Desa Matako terdiri dari 6
          (enam) dusun yang selama ini di kenal dengan dusun 1 s/d 6
        </p>
        <br />
        <p className="text-gray-600 text-md w-full text-justify">
