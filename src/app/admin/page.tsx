        ...
        <div className="table w-full">
          ...
          <div className="table-body ">
            <div className="flex px-5 md:py-5 py-2 border-t border-t-slate-100 ">
              <div className="w-full text-md font-medium text-slate-900 text-center">Balita</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">125 Jiwa</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">223 Jiwa</div>
              <div className="w-full text-md font-medium text-primary text-center">667 Jiwa</div>
            </div>
            <div className="flex px-5 md:py-5 py-2 border-t border-t-slate-100 ">
              <div className="w-full text-md font-medium text-slate-900 text-center">Anak-anak</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">125 Jiwa</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">223 Jiwa</div>
              <div className="w-full text-md font-medium text-primary text-center">667 Jiwa</div>
            </div>
            <div className="flex px-5 md:py-5 py-2 border-t border-t-slate-100 ">
              <div className="w-full text-md font-medium text-slate-900 text-center">Dewasa</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">125 Jiwa</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">223 Jiwa</div>
              <div className="w-full text-md font-medium text-primary text-center">667 Jiwa</div>
            </div>
            <div className="flex px-5 md:py-5 py-2 border-t border-t-slate-100 ">
              <div className="w-full text-md font-medium text-slate-900 text-center">Lansia</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">125 Jiwa</div>
              <div className="w-full text-md font-medium text-slate-900 text-center">223 Jiwa</div>
              <div className="w-full text-md font-medium text-primary text-center">667 Jiwa</div>
            </div>
